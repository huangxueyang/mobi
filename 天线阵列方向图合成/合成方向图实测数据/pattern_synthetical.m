...
d=0.125  %%单元间距
theta=[-180:1:180];
deg_min=-80;deg_max=80;mag_min=-40;mag_max=0;
...
t12_11_normal(:,2)=10.^(data_12_11(:,4)./10);     % 去除dB格式
...
for i=2:1:n1
  pattern_1_normal(:,i)=10.^(pattern_1(:,i)./10);     % 去除dB格式  
end
 pattern_1_normal(:,1)=pattern_1(:,1);
 
 [m1,n1]=size(pattern_2);
for i=2:1:n1
  pattern_2_normal(:,i)=10.^(pattern_2(:,i)./10);     % 去除dB格式  
end
 pattern_2_normal(:,1)=pattern_2(:,1);
 
[m1,n1]=size(pattern_3);
for i=2:1:n1
  pattern_3_normal(:,i)=10.^(pattern_3(:,i)./10);     % 去除dB格式  
end
 pattern_3_normal(:,1)=pattern_3(:,1);
 
[m1,n1]=size(pattern_4);
for i=2:1:n1
  pattern_4_normal(:,i)=10.^(pattern_4(:,i)./10);     % 去除dB格式  
end
 pattern_4_normal(:,1)=pattern_4(:,1);
 
[m1,n1]=size(pattern_5);
for i=2:1:n1
  pattern_5_normal(:,i)=10.^(pattern_5(:,i)./10);     % 去除dB格式  
end
...
for i=2:1:n1
  pattern_6_normal(:,i)=10.^(pattern_6(:,i)./10);     % 去除dB格式  
end
 pattern_6_normal(:,1)=pattern_6(:,1);
 
 [m1,n1]=size(pattern_7);
for i=2:1:n1
  pattern_7_normal(:,i)=10.^(pattern_7(:,i)./10);     % 去除dB格式  
end
 pattern_7_normal(:,1)=pattern_7(:,1);
 
[m1,n1]=size(pattern_8);
for i=2:1:n1
  pattern_8_normal(:,i)=10.^(pattern_8(:,i)./10);     % 去除dB格式  
end
 pattern_8_normal(:,1)=pattern_8(:,1);
 
[m1,n1]=size(pattern_9);
for i=2:1:n1
  pattern_9_normal(:,i)=10.^(pattern_9(:,i)./10);     % 去除dB格式  
end
 pattern_9_normal(:,1)=pattern_9(:,1);
 
[m1,n1]=size(pattern_10);
for i=2:1:n1
  pattern_10_normal(:,i)=10.^(pattern_10(:,i)./10);     % 去除dB格式  
end
 pattern_10_normal(:,1)=pattern_10(:,1);
 
 [m1,n1]=size(pattern_11);
for i=2:1:n1
  pattern_11_normal(:,i)=10.^(pattern_11(:,i)./10);     % 去除dB格式  
end
